...
public class clickDinnerList extends AppCompatActivity {
    TextView iteamName;
    ImageView imageView;
    TextView quantity;
    TextView calories;
    ...
    EditText editText;
    Button btnInfo;
    public static double dinnerCalories=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_click_dinner_list);
        iteamName = findViewById(R.id.iteamName);
        imageView = findViewById(R.id.dinnerListimage);
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(value!=null){
                    dinnerCalories= dinnerCalories+(Integer.parseInt(value)*Double.parseDouble(receiveCalories));
                    SharedPreferences sharedPref = getSharedPreferences("myKey", MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPref.edit();
                    editor.putString("value", String.valueOf(dinnerCalories));
                    editor.apply();
                }

                Intent intent = new Intent(clickDinnerList.this, calorieCalculator.class);
        ...
        btnInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(clickDinnerList.this,info.class);
